...
int main(int argc, char** argv)
{
	...
	int a_count0 = std::count_if(myObjects.begin(),myObjects.end(),[&](std::unique_ptr<O>& po){return po==0;});
	
	int a_count1 = 0;
	{
		Timer t("Visitor");
		IsAGetter isAGetter;
		a_count1 = std::count_if(myObjects.begin(),myObjects.end(),[&](std::unique_ptr<O>& po)
		{
	...
	int a_count2 = 0;
	{
		Timer t("GetType");
		IsAGetter isAGetter;
		a_count2 = std::count_if(myObjects.begin(),myObjects.end(),[&](std::unique_ptr<O>& po)
		{
