...
OS_T& operator << (OS_T& os, const Numeric<Object_T>& n) { return os << n.raw_value(); } 
...
MyNumber operator""_n (long double d) { return MyNumber(static_cast<double>(d)); }

int main(int argc, char* argv[])
{

#ifdef NUMERIC_CALLBACKS_ENABLED
  f_onAdd = [](double a, double b, double c) { std::cout << a << " + " << b << " = " << c << std::endl; };
  f_onSubtract = [](double a, double b, double c) { std::cout << a << " - " << b << " = " << c << std::endl; };
  f_onMultiply = [](double a, double b, double c) { std::cout << a << " * " << b << " = " << c << std::endl; };
  f_onDivide = [](double a, double b, double c) { std::cout << a << " / " << b << " = " << c << std::endl; };
#endif
